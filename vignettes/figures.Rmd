...
g2r comes with a number of figures that can be used to create visualisations. However, these can be used in many different ways than what is presented here in order to produce completely different looking charts; see [examples](/articles/examples.html).
...
g2(df, asp(x = x, color = grp)) %>% 
  fig_error(
    asp(ymin = ymin, ymax = ymax, size = 20), 
    adjust("dodge")
  ) %>% 
  fig_interval(
    asp(y = y), 
