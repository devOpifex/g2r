...
You can read more about [gauges in the vignette](gauges.html).
...
You can read more about [aspects in the vignette](aspects.html).
...
You can read more about [the adjust function in the vignette](adjust.html).
...
You can read more about [planes in the vignette](planes.html).
...
You can read more about [quick plots in the vignette](quick.html).
...
You can read more about [recipes in it vignette](recipes.html).

<a class="btn btn-default" href="figures.html">Explore figures</a>
